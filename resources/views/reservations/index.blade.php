...
@section('content')
    <div class="container mx-auto py-8">
        <h1 class="text-3xl font-bold text-center mb-6">Todas las reservas</h1>
        ...
        @else
            <div class="flex flex-wrap -mx-4">
                ...
                @php
                    ...
                    [$agendadas, $otras] = $reservations->partition(fn($reservation) => $reservation->status === 'Agendada');
                @endphp
                ...
                <div class="mb-6 p-4 bg-green-100 rounded-lg shadow-md w-full">
                    ...
                    <div class="flex flex-wrap">
                        @foreach ($agendadas as $reservation)
                            <div class="block p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200 mb-4 mx-4 w-full sm:w-1/2 lg:w-1/3">
